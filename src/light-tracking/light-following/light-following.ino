...
#define LDR_R_PIN A1
 // Mapped to ATMega328P PC1 (Pin 24) on Arduino Uno
...
#define LDR_LOCK_THRESHOLD 200
#define MOTOR_L_FORWARD_PWM_VALUE 160
#define MOTOR_R_FORWARD_PWM_VALUE 200

#define MOTOR_L_REVERSE_PWM_VALUE -160
#define MOTOR_R_REVERSE_PWM_VALUE -200

#define MOTOR_L_LEFT_TURN_PWM_VALUE 120
#define MOTOR_R_LEFT_TURN_PWM_VALUE 180

#define MOTOR_L_RIGHT_TURN_PWM_VALUE 180
#define MOTOR_R_RIGHT_TURN_PWM_VALUE 120

#define MOTOR_TURN_DURATION_MS 0
